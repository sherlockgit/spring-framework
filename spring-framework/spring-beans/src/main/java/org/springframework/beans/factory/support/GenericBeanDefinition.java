...
/**
 * 从spring2.5开始，提供了一个更好的注册BeanDefinition类Gene
 * ricBeanDefinition，它支持动态定义父依赖，GenericBeanDefinition
 * 可以有效的替代ChildBeanDefinition的绝大部分使用场合。
 *
 * 可以动态设置parent bean定义，也可以不设置parent bean定义，
 * 由此可见，GenericBeanDefinition既可以替代RootBeanDefinition，
